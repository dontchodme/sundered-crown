...
| bloodsworn × scythe | Bloodmirror / Bloodletting, **BUILD** — stage T (tip surface) and stages 1-2 green; blade at 3b. Tip hook off `_scBarbed` and the landing ring + stronger pool are Rick's, 2026-09-01 | Claude Code | 2026-09-01 | BUILDING | `tools/bloodmirror_build.py` |
...
| umbral × scythe | Duskreave / Scour, **BUILD** — built from `06-docs/v63/DUSKREAVE-BUILD-BRIEF.md` on the chain tip `02-chain/sc-bloodletting.html` (32 relics), so Duskreave is the 33rd. Built against **today's curse rule** (keep the 3 BIGGEST) because the last-3 window is not in the link — brief §1, gate 6 prices whatever is there. | Claude Code | 2026-09-02 | BUILDING | `tools/duskreave_build.py` |
| **CURSE RULE, school-wide** | the pool keeps the LAST 3 hits instead of the 3 BIGGEST — Rick's ruling 2026-09-02. **LANDS AFTER GLOAMWIRE SHIPS, not under it.** Its own commit, gated on re-pricing the four built umbral relics (v62 §13b) and Scour. | Cowork | 2026-09-02 00:3x | DESIGNED, NOT TO LAND YET | `06-docs/v63/curse-window-v63.md` |
| **vigil × twinblade** | the 34th relic — cell chosen by Rick 2026-09-02 from four priced (v62 table). No name, no ultimate yet. **IN PROGRESS — do not design this cell, do not build it.** | Cowork | 2026-09-02 02:40 | OPEN | `06-docs/v64/vigil-twinblade-design-v64.md` |
