...
("sfx.nightfell", '''          this._tone (t + 0.05, { freq: 340, to: 96, gain: 0.13, dur: 0.42, type:"triangle" });
 ...
 '''          this._tone (t + 0.05, { freq: 340, to: 96, gain: 0.13, dur: 0.42, type:"triangle" });
          ...
          /* A CRACK, NOT A THUD. Five of these can land inside 42ms, so it
             has to stack into a roll rather than into mud: the low end is
             short and the bright end is where the energy is. */
          this._burst(t, { freq: 5200, q: 1.0, gain: 0.20, dur: 0.06, type:"highpass" });
          this._tone (t, { freq: 420, to: 90, gain: 0.22, dur: 0.20, type:"sawtooth" });
          this._burst(t + 0.02, { freq: 260, q: 0.6, gain: 0.16, dur: 0.14, type:"lowpass" });
        } else {                                        // rune-crack'''),
